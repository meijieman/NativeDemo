...
#ifndef NATIVEDEMO_BASECHANNEL_H
#define NATIVEDEMO_BASECHANNEL_H
...
public:
    ...
    SafeQueue<AVPacket *> pkt_queue;// 编码数据包（封装数据）队列
    SafeQueue<AVFrame *> frame_queue;// 解码数据包（原始数据）队列
...
#endif //NATIVEDEMO_BASECHANNEL_H
